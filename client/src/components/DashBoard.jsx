...
const DashBoard = ({ updateLocalForAll }) => {
    ...
    const [dataFetched, setDataFetched] = useState([0,1,2,3])
    const [dataFetched1, setDataFetched1] = useState([0,1,2,3])
    ...
    if ( (JSON.stringify(dataFetched) === JSON.stringify(dataFetched1))) {
        return <Spinner />
     }
